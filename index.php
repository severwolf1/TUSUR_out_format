...
<head>
    ...
    <link rel="shortcut icon" href="/img/01.jpg" type="image/jpg">
    <title>OUR_FORMAT</title>
</head>
<body>
            ...
            <div class="col">
                <div class="card" style="margin-top: 20px; border: 0px solid lightblue; border-radius: 20px; ">
                    <div class="card-body" style="border-radius: 20px; ">
                        <div class="row">
                            <div class="col"><a href="index.php"><img src="/img/01.jpg" width="100%"></a></div>
                            <div class="col-10"><h4><b style="color: rgb(29, 173, 29); font-size: 30px; font-size: 5vh;">Центр социально-профессионального волонтёрства ТУСУР «Наш формат»</b></h4> 
                            <h5><p style="font-size: 20px; font-size: 4vh;">Центр волонтёрства «Наш формат» способствует развитию социально-профессионального волонтерства в ТУСУРе и его включению в международные волонтерские программы</p></h5></div>
                        </div>
                    </div>
                </div>
                        ...
                        <center>
                            ...
                            if ($_SESSION['online'] == 1) {
                                ...
                                if ($_SESSION['type'] == "org" && $_SESSION['valid'] == 0)
                                    echo "<p><b  style='color: red'>ВАШ АКАУНТ НЕ ПОДТВЕРЖДЁН!</b></p>";
