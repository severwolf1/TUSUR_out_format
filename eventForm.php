...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha3 4-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
        ...
        <div class="row">
            <div class="col">
                        <div class="card" style="width: 50%; margin: auto; margin-top: 2%; margin-bottom: 1%; border-radius: 20px; text-align: center;">
                            <div class="card-body">
                                <h5 class="card-title">СОЗДАНИЕ СОБЫТИЯ</h5>
                                <hr>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="name" class="form-control" placeholder="Название" aria-label="Название">
                                </div>  
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="category" class="form-control" placeholder="подработка общение" aria-label="Категория">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
